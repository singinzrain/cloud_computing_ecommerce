"""
Django settings for hw3_ecommerce project.
...
SECRET_KEY = 'django-insecure-k6%@s(0zvn466u%g^8imlc(v*#2zk_d6e^)c8zx=zgh$hxn@+)'
...
WSGI_APPLICATION = 'hw3_ecommerce.wsgi.application'
...
# S3_BUCKET_NAME = "zappa-q7wxvz37z"
